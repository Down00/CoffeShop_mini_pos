...
public class coffeeprd extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {

    RecyclerView recyclerView;
    ArrayList<coffeeItem> items;
    ImageView drawern, add, filterlist;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.coffeeprd);
        ...
        coffeeAdapter= new coffeeAdapter(this, items);
        recyclerView.setAdapter(coffeeAdapter);
        searchView = findViewById(R.id.searchbar);
        drawern = findViewById(R.id.drawer);
        ...
        add.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(coffeeprd.this, coffeeinv.class);
        ...
        builder.setItems(categories, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (selectedCategory.equals("None")) {
                    ...
                    coffeeAdapter.setFilteredList(items);
                } else {
    ...
    private void filterProductsByCategory(String category) {
        ...
        if (filteredList.isEmpty()) {
            Toast.makeText(this, "No menu found in this category", Toast.LENGTH_SHORT).show();
        } else {
            coffeeAdapter.setFilteredList(filteredList);
        }
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            // Handle Home click
            Intent intent = new Intent(coffeeprd.this, Dashboard.class);
            startActivity(intent);
        } else if (id == R.id.sales) {
            // Handle Sales History click
            Intent intent = new Intent(coffeeprd.this, Sales.class);
            startActivity(intent);
        } else if (id == R.id.menu) {
            // Handle Sales History click
            Intent intent = new Intent(coffeeprd.this, coffeeee.class);
            startActivity(intent);
        } else if (id == R.id.invent) {
            // Handle Inventory click
            Intent intent = new Intent(coffeeprd.this, coffeeprd.class);
            startActivity(intent);
        } else if (id == R.id.queue) {
            // Handle Inventory click
            Intent intent = new Intent(coffeeprd.this, Queue.class);
            startActivity(intent);
        } else if (id == R.id.nav_about) {
            // Handle Inventory click
            Intent intent = new Intent(coffeeprd.this, About.class);
            startActivity(intent);
        } else if (id == R.id.nav_logout) {
            // Show confirmation dialog before logging out
            AlertDialog.Builder builder = new AlertDialog.Builder(coffeeprd.this);
            ...
            builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    Intent intent = new Intent(coffeeprd.this, loginJ.class);
                    intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                    startActivity(intent);
                    Toast.makeText(coffeeprd.this, "Successfully logged out!", Toast.LENGTH_LONG).show();
                    finish();
                }
            });
